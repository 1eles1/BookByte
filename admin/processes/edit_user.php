...
// Get user data
try {
    $stmt = $db->prepare("SELECT * FROM tbllogininformation WHERE id = :id AND accounttype = 'librarian'");
    ...
    try {
        ...
        if ($checkStmt->rowCount() > 0) {
            ...
            if ($stmt3->execute()) {
                ...
                $error_message = "Failed to update librarian. Please try again.";
            }
        }
    } catch (Exception $e) {
    ...
    <div class="sidebar-layout">
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    <div class="nav-section-title">Librarian Management</div>
        ...
        <div class="main-content">
            ...
            <div class="top-header">
                ...
                <h1 class="header-title">Edit Librarian</h1>
                        ...
                        <form method="POST" action="edit_user.php?id=<?php echo $user_id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="year_level" class="form-control" required>
                                    ...
                                    <option value="1" <?php echo (isset($personal_data['year_level']) && $personal_data['year_level'] === '1') ? 'selected' : ''; ?>>Head Librarian</option>
                                    <option value="2" <?php echo (isset($personal_data['year_level']) && $personal_data['year_level'] === '2') ? 'selected' : ''; ?>>Assistant Librarian</option>
                                    <option value="3" <?php echo (isset($personal_data['year_level']) && $personal_data['year_level'] === '3') ? 'selected' : ''; ?>>Library Staff</option>
                                    <option value="4" <?php echo (isset($personal_data['year_level']) && $personal_data['year_level'] === '4') ? 'selected' : ''; ?>>Other</option>
                                </select>
                            </div>
                            
                            <div class="d-flex gap-2">
                                <button type="submit" name="update" class="btn btn-success">
                                    <i class="fas fa-save"></i> Update Librarian
                                </button>
                                <a href="manage_users.php" class="btn btn-primary">
